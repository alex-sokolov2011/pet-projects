...
| --- | --- | --- | --- |
| [ML ренировки Яндекс + ШАД/2023](https://github.com/alex-sokolov2011/skillfactory_rds/tree/master/module_10) | Первые ML тренировки Яндекса, которое созданы совместно со Школой анализа данных | 8 лекций + 4 домашних задания + сорев| numpy, sklearn, PyTorch |  
