...
***Результат по модулю 3*** - 9 место на kaggle из 96 участников закрытого соревнования (Топ 10%). оценка командой курса - 90 баллов из 100 (Соблюдение стандартов оформления pep-8 = 75, Наличие визуализации с выводами (корреляция и важность признаков) = 100, Feature Engineering и обогащение датасета = 100, Работа с метрикой МАЕ = 100, Использование внешних источников данных = 75):arrow_left:[к Модулю 3](https://github.com/alex-sokolov2011/skillfactory_rds/tree/master/module_3)  
