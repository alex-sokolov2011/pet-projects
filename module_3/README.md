...
### Результат  
- score - 0.16870  
- на 15.06.2020 9 место из 96 участников (Тор 10%)   
- оценка командой курса - 90 баллов из 100 (Соблюдение стандартов оформления pep-8 = 75, Наличие визуализации с выводами (корреляция и важность признаков) = 100, Feature Engineering и обогащение датасета = 100, Работа с метрикой МАЕ = 100, Использование внешних источников данных = 75)  
